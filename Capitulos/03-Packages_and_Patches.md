...
Descargue el archivo de "wget-list-systemd" (wget https://www.linuxfromscratch.org/lfs/view/stable-systemd/wget-list-systemd) para tener el listado de paquetes en un archivo, posteriormente usar el siguiente comando para descargar todo en el directorio de sources:

    wget --input-file=wget-list-systemd --continue --directory-prefix=$LFS/sources

Hacer lo mismo con el archivo de md5sums (wget https://www.linuxfromscratch.org/lfs/view/stable-systemd/md5sums) para comparar los hashes de los paquetes descargados con los deseados:
